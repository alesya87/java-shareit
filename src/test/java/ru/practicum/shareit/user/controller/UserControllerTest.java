...
public class UserControllerTest {
    ...
    @Test
    public void shouldThrowExceptionWhenAddUserIfNameEmpty() throws Exception {
        UserAddDto userAddDto = new UserAddDto("", "asdfgh@gmail.com");
        ...
        verify(userService, never()).addUser(userAddDto);
    }

    @Test
    public void shouldThrowExceptionWhenAddUserIfEmailEmpty() throws Exception {
    ...
    @Test
    public void shouldThrowExceptionWhenAddUserIfEmailNotCorrect() throws Exception {
        UserAddDto userAddDto = new UserAddDto("name", "email.com");
        Matcher<String> contentMatcher = CoreMatchers
    ...
    @Test
    public void shouldThrowExceptionWhenUpdateUserIfEmailNotCorrect() throws Exception {
        UserUpdateDto userUpdateDto = new UserUpdateDto("Вася", "gmail.com");
        Matcher<String> contentMatcher = CoreMatchers
                .containsString("must be a well-formed email address");
        ...
        verify(userService, never()).updateUser(userUpdateDto, 1L);
    }
