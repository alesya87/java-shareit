...
class BookingServiceImplUnitTest {
    ...
    public void shouldThrowIncorrectTimeDateExceptionWhenAddBookingIfEndIsBeforeStart() {
        ...
        Exception exception = assertThrows(ru.practicum.shareit.exception.IncorrectTimeDateException.class,
    ...
    @Test
    public void shouldThrowEntityNotFoundExceptionWhenGetAllUserBookingsByStateIfUnsupportedStatus() {
    ...
    @Test
    public void shouldThrowEntityNotFoundExceptionWhenGetAllItemBookingsUserByStateIfUnsupportedStatus() {
        BookingStatus bookingStatus = BookingStatus.UNSUPPORTED_STATUS;
        long userId = 1L;
        int from = 0;
        int size = 10;
